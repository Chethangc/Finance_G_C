 ...
 * Use the {@link Investments#newInstance} factory method to
...
public class Investments extends Fragment {
    ...
    public static Investments newInstance(String param1, String param2) {
        Investments fragment = new Investments();
